...
class TestCity(unittest.TestCase):
    ...
    def test_name_attr(self):
        """Test that City has attribute name, and it's as an empty string"""
        city = City()
    ...
    def test_to_dict_values(self):
        ...
        self.assertEqual(new_d["created_at"], ct.created_at.strftime(t_format))
        self.assertEqual(new_d["updated_at"], ct.updated_at.strftime(t_format))
